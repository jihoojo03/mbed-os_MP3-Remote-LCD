...
int TransmitterIR::setData(RemoteIR::Format format, uint8_t *buf, int bitlength) {
    ...
    switch (format) {
        case RemoteIR::NEC:
            ticker.detach();
            ticker.attach_us(callback(this, &TransmitterIR::tick), RemoteIR::TUS_NEC);
            break;
        case RemoteIR::AEHA:
            ticker.detach();
            ticker.attach_us(callback(this, &TransmitterIR::tick), RemoteIR::TUS_AEHA);
            break;
        case RemoteIR::SONY:
            ticker.detach();
            ticker.attach_us(callback(this, &TransmitterIR::tick), RemoteIR::TUS_SONY);
            break;
    }
